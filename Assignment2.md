...
* **Link to the code run on Jupyter Notebook(.py file) for the answers below**: [click here](https://github.com/shreyar007/INF502/blob/main/code/INF502%20--%20Assignment%202.py)
